...
const  Footer = () =>(
    <section className={`${styles.flexCenter} ${styles.paddingy} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col md-8 w-full`}>
        <div className="flex-1 flex flex-col justify-start mr10">
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45] mt-3">
