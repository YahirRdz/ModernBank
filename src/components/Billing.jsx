...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
        <img src={apple} alt="apps_store" className="w-[128px] h-[42px] object-contain mr-5 cursor-pointer" />
        <img src={google} alt="apps_store" className="w-[128px] h-[42px] object-contain cursor-pointer" />
      </div>
      </div>
    </section>
  )
